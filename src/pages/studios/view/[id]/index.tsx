...
import { getStudioById } from 'apiSdk/studios';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('studio', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/studios/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('project', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/projects/create?studio_id=${data?.id}`}>
